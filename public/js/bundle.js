...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false //center: [-118.113491, 34.111745], //- Longitude and latitude. mapbox expects longitude and then latitude just like mongo DB. Have a look at mapbox GL JS documentation for various options
    //zoom: 10,
    //interactive: false

  }); //- Create the id element called map and copy the snippet from mapbox. It will put the map on the element with the id of map

  var bounds = new mapboxgl.LngLatBounds(); //- Area displayed on the map. We get access to mapbox gl, coz we included the library as part of the script in tour.pug
...
var hideAlert = function hideAlert() {
  var el = document.querySelector('.alert'); //Move to parent element and remove the child
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              //res.data is what we send as JSON response
              (0, _alerts.showAlert)('success', 'Logged in successfully!'); //To reload another page after a specific time - 1500ms
          ...
          case 9:
            ...
            (0, _alerts.showAlert)('error', _context.t0.response.data.message); //From axious documentation
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', _context.t0.response.data.message); //Message property is defined on the server whenever there is an error
...
var stripe = Stripe('pk_test_51LQiPuSJsURRaEamTdos0ePwJY8ImdumFnpzWwA3EKXVdisSLcwQiYRpbkrxSoEz1PB7k5V7tN2NdVG5r8yfHQDw00khMVJ81F');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //2) Create checkout form + charge credit card (This is a stripe API)
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault(); //Multi part form data upload such as photos
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            //updateSettings function is an async call which returns a promise
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = e.target.dataset.tourId; //e is the element that was clicked. Whenever there is a -, JS converts it to camelcase
